...
class Maze(tk.Tk):
    ...
    def _build_maze(self):
        ...
        hell3_center = origin + np.array([UNIT, UNIT * 9])
        self.hell3 = self.canvas.create_rectangle(
            hell3_center[0] - 15, hell3_center[1] - 15,
            hell3_center[0] + 15, hell3_center[1] + 15,
            fill='black')

        hell4_center = origin + np.array([UNIT * 3, UNIT * 13])
        ...
        hell7_center = origin + np.array([UNIT * 7, UNIT * 9])
        self.hell7 = self.canvas.create_rectangle(
            hell7_center[0] - 15, hell7_center[1] - 15,
            hell7_center[0] + 15, hell7_center[1] + 15,
            fill='black')

        hell8_center = origin + np.array([UNIT * 8, UNIT * 11])
